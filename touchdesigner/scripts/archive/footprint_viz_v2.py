"""Footprint visualizer — Script TOP callbacks v2 (numpy only, HD 1920x1080).

CHANGES v2: added scriptOp.resize() to force HD output resolution.
...
def cook(scriptOp):
    scriptOp.resize(PROJ_W, PROJ_H)   # force HD output
