...
> Interpretation note:
> Some requirement lines below preserve the original course wording from the early planning stage, including references to `Grasshopper`, `Anemone`, and older state labels such as `CHECKING`.
> The working project implementation has since locked to the TouchDesigner runtime FSM in [PROJECT.md](/o:/Hardware_III/.planning/PROJECT.md), [ROADMAP.md](/o:/Hardware_III/.planning/ROADMAP.md), and [fsm_full.py](/o:/Hardware_III/touchdesigner/scripts/fsm_full.py).
